...
sys.path.append('/home/pi/Pibo_Package_11/Pibo_Play/')
...
class Com():
    ...
    def com_1(self):
        ...
        while True:
            time.sleep(1)
            audio.audio_play(filename="/home/pi/Pibo_Package_11/Pibo_Play/data/behavior/audio/sound_standing.mp3", volume=-2000, background=False)
