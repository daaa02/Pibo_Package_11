...
from Pibo_Package_11.Pibo_Conversation.src.drive_upload import drive_upload
...
class RunSchedule():
    ...
    def day(self):
        ...
        try:
            ...
            logfile = f'(P11)_{datetime.now().strftime("%m%d_%H%M")}.txt'   #('P<PACKAGE_NUMBER>_DATE.txt')   
