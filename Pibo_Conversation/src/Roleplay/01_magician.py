...
class Roleplay():    
    ...
    def Magician(self):
        ...
        if rand == 1:
            self.role = "마법사"
            audio.audio_play("/home/pi/Pibo_Package_11/Pibo_Conversation/src/Roleplay/Sound/01_magic.wav")
            pibo = cm.tts(bhv="do_explain_A", string="이제 우리는 하늘에 사는 마법사야. 파이보가 먼저 주문을 걸어볼게. 천둥아 쳐라 얍!")
            audio.audio_play("/home/pi/Pibo_Package_11/Pibo_Conversation/src/Roleplay/Sound/01_magic.wav")
            audio.audio_play("/home/pi/Pibo_Package_11/Pibo_Conversation/src/Roleplay/Sound/04_thunder.wav")
                ...
                for i in range(len(weather)):
                    if weather[i] in answer[1]:
                        ...
                        if "비" in answer[1]:   # "비바람" 도 여기 들어감
                            audio.audio_play("/home/pi/Pibo_Package_11/Pibo_Conversation/src/Roleplay/Sound/01_magic.wav")
                            audio.audio_play("/home/pi/Pibo_Package_11/Pibo_Conversation/src/Roleplay/Sound/02_rain.wav")
                            print("비")
                            
                        if "바람" in answer[1]:
                            audio.audio_play("/home/pi/Pibo_Package_11/Pibo_Conversation/src/Roleplay/Sound/01_magic.wav")
                            audio.audio_play("/home/pi/Pibo_Package_11/Pibo_Conversation/src/Roleplay/Sound/05_wind.wav")
                            print("바람")                            
                        ...
                        if "눈" in answer[1]:
                            audio.audio_play("/home/pi/Pibo_Package_11/Pibo_Conversation/src/Roleplay/Sound/01_magic.wav")
                            audio.audio_play("/home/pi/Pibo_Package_11/Pibo_Conversation/src/Roleplay/Sound/06_snow.wav")  
                            print("눈")                                          
                        
                        if "해" or "맑" in answer[1]:
                            audio.audio_play("/home/pi/Pibo_Package_11/Pibo_Conversation/src/Roleplay/Sound/01_magic.wav")
                            audio.audio_play("/home/pi/Pibo_Package_11/Pibo_Conversation/src/Roleplay/Sound/03_clear.wav")    
                            print("해")
        ...
        if rand == 2:
            ...
            audio.audio_play("/home/pi/Pibo_Package_11/Pibo_Conversation/src/Roleplay/Sound/01_magic.wav")
            audio.audio_play("/home/pi/Pibo_Package_11/Pibo_Conversation/src/Roleplay/Sound/07_owl.wav")
            ...
            if answer[0][0] == "action" or answer[0][0] == "positive":  
                if "늑대" in answer[1]:                    
                    audio.audio_play("/home/pi/Pibo_Package_11/Pibo_Conversation/src/Roleplay/Sound/01_magic.wav")
                    audio.audio_play("/home/pi/Pibo_Package_11/Pibo_Conversation/src/Roleplay/Sound/08_wolf.wav")
            ...
            if answer[0][0] == "action" or answer[0][0] == "positive":  
                if "코끼리" in answer[1]:                    
                    audio.audio_play("/home/pi/Pibo_Package_11/Pibo_Conversation/src/Roleplay/Sound/01_magic.wav")
                    audio.audio_play("/home/pi/Pibo_Package_11/Pibo_Conversation/src/Roleplay/Sound/09_elephant.wav")
        ...
        if rand == 3:
            ...
            audio.audio_play("/home/pi/Pibo_Package_11/Pibo_Conversation/src/Roleplay/Sound/01_magic.wav")
            audio.audio_play("/home/pi/Pibo_Package_11/Pibo_Conversation/src/Roleplay/Sound/11_seagull.wav")
            ...
            if answer[0][0] == "action" or answer[0][0] == "positive":  
                if "오리" in answer[1]:                    
                    audio.audio_play("/home/pi/Pibo_Package_11/Pibo_Conversation/src/Roleplay/Sound/01_magic.wav")
                    audio.audio_play("/home/pi/Pibo_Package_11/Pibo_Conversation/src/Roleplay/Sound/12_duck.wav")
            ...
            if answer[0][0] == "action" or answer[0][0] == "positive":  
                if "개구리" in answer[1]:                    
                    audio.audio_play("/home/pi/Pibo_Package_11/Pibo_Conversation/src/Roleplay/Sound/01_magic.wav")
                    audio.audio_play("/home/pi/Pibo_Package_11/Pibo_Conversation/src/Roleplay/Sound/13_frog.wav")
                    pibo = cm.tts(bhv="do_joy_B", string="우와. 주문을 잘 거는 걸?")   
