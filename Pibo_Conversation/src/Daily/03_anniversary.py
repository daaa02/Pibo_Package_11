...
class Daily():    
    ...
    def Bday(self):   
        ...
        # 1.1 기념일 알림
        audio.audio_play(filename="/home/pi/Pibo_Package_11/Pibo_Conversation/data/behavior/audio/sound_cheerfulness2.wav", out='local', volume=-1500, background=False)
