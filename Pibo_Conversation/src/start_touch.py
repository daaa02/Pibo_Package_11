...
while True:
    ...
    if result == "touch":
        ...
        #     oled.show()
        #     # oled.draw_image("/home/pi/Pibo_Package_11/Pibo_Conversation/data/behavior/icon/icon_default2.png")
        #     # oled.show()
        
        # if count % 2 == 0:
        #     # oled.draw_image("/home/pi/Pibo_Package_11/Pibo_Conversation/data/behavior/icon/icon_default1.png")
        #     # oled.show()
            ...
            if "소개" in answer[0][1] or "반가" in answer[0][1]:
                os.system('python3 /home/pi/Pibo_Package_11/Pibo_Conversation/src/greeting.py')
                # break
            
            if "헤어" in answer[0][1]:
                os.system('python3 /home/pi/Pibo_Package_11/Pibo_Conversation/src/goodbye.py') 
                # break
            ...
            if answer[0][0] == 'positive' or answer[0][0] == 'action':
                ...
                break
            # os.system('python3 /home/pi/Pibo_Package_11/Pibo_Conversation/src/schedule_run.py')
